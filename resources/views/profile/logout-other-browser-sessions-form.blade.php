<x-action-section class="mb-28">
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Jika perlu, Anda dapat keluar dari semua sesi peramban Anda di semua perangkat Anda. Beberapa sesi terbaru Anda tercantum di bawah ini; namun, daftar ini mungkin tidak lengkap. Jika Anda merasa akun Anda telah dikompromikan, Anda juga harus memperbarui kata sandi Anda.') }}
        </div>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="font-semibold text-green-500">{{ __('Perangkat ini') }}</span>
                                    @else
        ...
        <!-- Konfirmasi Keluar dari Perangkat Lain Modal -->
