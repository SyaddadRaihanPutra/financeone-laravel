...
@section('content')
    <div class="container pt-12 mx-auto">
        <div class="p-5 mt-5 transition-all bg-white shadow-lg rounded-xl hover:shadow-xl">
            ...
            <button
                class="px-3 py-2 mt-3 text-sm text-white transition-all transform rounded-md bg-slate-700 hover:bg-slate-800 font-base"><i
                    class="ti ti-printer"></i> Cetak Laporan</button>
